...
└── Header/
    ├── 1.jpg                # Оверлей — пурпурный
    ├── 2.jpg                # Оверлей — синий
    ├── 3.jpg                # Оверлей — зелёный
    └── 4.jpg                # Оверлей — ластик
```
...
| Жест | Действие |
|------|----------|
| ☝️ 1 палец (указательный) | Рисование |
| ✌️ 2 пальца (указ. + средний) | Выбор цвета — поднять руку в верхнюю зону экрана |
| 🖐 Все 5 пальцев | Очистить холст |

Кнопки в интерфейсе дублируют выбор цвета и очистку.
